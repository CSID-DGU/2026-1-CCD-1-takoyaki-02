...
STATIC_LINES: list[str] = [
    # ── 웨어울프 ──────────────────────────────────────────────────────────────────
    "밤이 되었습니다. 모두 눈을 감으세요.",
    "도플갱어, 눈을 뜨고 다른 플레이어의 카드를 확인하세요.",
    "늑대인간, 눈을 뜨고 서로를 확인하세요.",
    "하수인, 눈을 뜨고 늑대인간을 확인하세요.",
    "프리메이슨, 눈을 뜨고 서로를 확인하세요.",
    "예언자, 눈을 뜨고 카드를 확인하세요.",
    "도둑, 눈을 뜨고 원하는 플레이어의 카드를 훔치세요.",
    "말썽꾼, 눈을 뜨고 두 플레이어의 카드를 교환하세요.",
    "술꾼, 눈을 뜨고 가운데 카드 중 하나와 자신의 카드를 교환하세요.",
    "불면증 환자, 눈을 뜨고 자신의 카드를 확인하세요.",
    "모두 눈을 뜨세요! 토론을 시작합니다.",
